...
<head>
	...
	<?php 
		...
		require_once('../../model/selection_sinistre1.php');
	?>
	<div class="contenair col-lg-12 col-md-6">
			<div align="center">
				<img src="../../includes/111.PNG" width="100px" height="120px">
				<h2 style="font-weight: bold;"><u> LISTE DES CAS DE SINISTRE NON TRAITER</u></h2>
			...
			<div class="col-md-12 col-xs-12 ">
				...
				<div class="panel panel-info">
					...
					<div class="panel-heading">
						LISTE DES CAS DE SINISTRE NON TRAITER
					</div>	
					...
					<div class="panel-body">
						<div class="table-responsive table--no-card m-b-30">
							<table class="table table-striped">
								<thead>
									<tr>
											<th>ID</th><th>NUMERO ASSURANCE</th><th>MESSAGE</th><th>DATES</th>
									</tr>
								</thead>
															<tbody>
